/* Generated by Cython 0.17 on Mon Mar 18 16:27:16 2013 */
...
static PyObject *__pyx_pf_7wripaca_2omegacalc(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_gve, PyArrayObject *__pyx_v_pre, PyArrayObject *__pyx_v_post, PyArrayObject *__pyx_v_axis, double __pyx_v_wvln) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_gve.rcbuffer->pybuffer, (PyObject*)__pyx_v_gve, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
